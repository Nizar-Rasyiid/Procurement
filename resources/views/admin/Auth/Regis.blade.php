                            ...
                            <div class="p-5">
                                ...
                                <form method="POST">
                                    <div class="form-group mt-2">
                                        <input id="name" type="name" class="form-control form-control-user" name="name" required placeholder="Masukkan nama anda">
                                    ...
                                    <div class="form-group mt-2">
                                        <input class="form-control" type="date" name="date" required placeholder="Masukkan Tanggal lahir anda" id="">
                                    </div>
                                    <div class="form-group mt-2">
